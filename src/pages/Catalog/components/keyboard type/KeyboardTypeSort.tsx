...
export default function KeyboardTypeSort({ setProductsArray }:{setProductsArray:any}) {
    ...
    const allTypes = ["Игровая", "Офисная"]
    ...
    useEffect(() => {
        if (selectedTypes.length === 0) {
            ...
            const filtered = productsArray.filter(product =>
                selectedTypes.includes(product.specificity)
            );
    ...
    return (
        <div className="keyboardTypeSortMain">
            <div className="keyboardTypeSortMain">
                ...
                >
                    {allTypes.map((item: string, index: number) => (
